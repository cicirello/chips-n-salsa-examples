...
/**
 * This example demonstrates how to use the Configurator class to configure the pseudorandom number
 * generator used by the library.
 *
...
public class ConfigureRandomness {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Demonstrating Configurator for specifying seed to exactly replicate behavior.");
