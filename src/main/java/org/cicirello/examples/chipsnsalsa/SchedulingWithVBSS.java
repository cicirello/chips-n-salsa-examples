 ...
 * solving difficulty.
 *
 * <p>This example demonstrates using one of the stochastic sampling search algorithms, VBSS, as
 * well as a hybrid of VBSS and hill climbing.
 *
...
public class SchedulingWithVBSS {
  ...
  public static void main(String[] args) {
    ...
    ValueBiasedStochasticSampling<Permutation> vbss =
        new ValueBiasedStochasticSampling<Permutation>(heuristic, 8);
    ...
    FirstDescentHillClimber<Permutation> hybrid =
        new FirstDescentHillClimber<Permutation>(
            ...
            new InitializeBySimpleMetaheuristic<Permutation>(
                new ValueBiasedStochasticSampling<Permutation>(heuristic, 8)));
    ...
    // class for that.  We just pass the factory method the heuristic.
    HeuristicPermutationGenerator atcs =
        HeuristicPermutationGenerator.createHeuristicPermutationGenerator(heuristic);
