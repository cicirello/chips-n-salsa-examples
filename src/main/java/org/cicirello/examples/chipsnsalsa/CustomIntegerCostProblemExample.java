...
/**
 * This example demonstrates how to use simulated annealing for an optimization problem, where the
 * cost of a solution is integer valued. In particular, it provides an example of implementing the
 * IntegerCostOptimizationProblem interface to define your own optimization problem.
 *
...
public class CustomIntegerCostProblemExample {
  ...
  private CustomIntegerCostProblemExample() {}
